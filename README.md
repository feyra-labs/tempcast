...
scripts/          make_synth, make_points, fetch_era5, make_era5, fetch_ghcnh, make_ghcnh, make_splits, build_cache, train, run (Hydra), train_neurobaselines, baseline_cards, calibrate, export_onnx, plot_loss
